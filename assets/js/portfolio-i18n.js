(() => {
  ...
  const translations = {
    ...
    'AltTab 主显示器窗口切换实际运行界面': 'AltTab runtime switcher on the main display',
    '主显示器 · 按屏分组显示实时窗口缩略图': 'Main Display · Live window thumbnails grouped by display',
    'AltTab 外接显示器窗口切换实际运行界面': 'AltTab runtime switcher on the external display',
    '外接显示器 · 同一次快捷键触发同步出现': 'External Display · Appears from the same keyboard shortcut',
    'AltTab 所有屏幕模式设置界面': 'AltTab All Displays mode settings',
    '设置界面 · “多个屏幕”选择“所有屏幕”': 'Settings · Choose All Displays under Multiple Displays',
    '所有屏幕': 'All Displays',
